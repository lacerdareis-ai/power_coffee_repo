# Figma Scripter — HE-OS Document

**Type:** Figma Scripter (Plugins > Scripter > Run)
**Output:** 10 slides · 1440 × 900 · landscape
**Last updated:** 2026-06-05
**Source file:** `daily_content/_brand_kit/figma_heos_doc.js`

## What it generates

| Slide | Content |
|---|---|
| 01 · Cover | HE-OS hero + 3 layer badges |
| 02 · Architecture | Intelligence / Knowledge / Automation 3-column diagram |
| 03 · Content Flow | /brain → generate → publisher → 7 platforms → /lens loop |
| 04 · Cron Schedule | All 13 cron jobs with time + description |
| 05 · Platforms | 7 platform cards (IG, X, LinkedIn, TG, WA, Shopify, Email) |
| 06 · Skills | /brain /pulse /lens /studio /ads cards with triggers |
| 07 · Credentials Map | All .env keys grouped by service |
| 08 · Alerting Rules | ✅ ALWAYS → DM  ❌ NEVER → group |
| 09 · Known Limits | Status items (ACTIVE / PENDING / DISABLED) |
| 10 · Cloud Routines | 3 routines — 2 DISABLED + 1 ENABLED |
