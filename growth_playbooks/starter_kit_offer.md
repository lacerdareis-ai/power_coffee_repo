# Power Starter Kit — Offer Structure

**Status:** Not yet live. Priority: High (AOV lever, habit formation driver, UGC engine).
**Source:** market.md short-term growth priorities.
...
- 1 ceramic mug or travel cup with brand mark
- 1 laminated 7-Day First Win card (daily ritual guide, QR code for community)
...
After the kit checkout, offer:
> "Add a monthly bag for $15.21 (15% off, cancel anytime) — never run out."

Subscribers who start with the kit have a mug and a habit. Retention should be materially higher than standalone bag subscribers.

---

## Implementation steps

1. Source the scoop (custom engraved metal scoop, ~$2-3 landed cost at 100 units — check Alibaba / CJ Dropshipping)
2. Source the mug (12oz ceramic, brand logo heat-printed, ~$4-5 landed at 50 units)
3. Design the 7-Day card (Figma, folded card, QR code to a landing page or Telegram group)
4. Create a Shopify bundle product ("Power Morning Kit") using Shopify Bundles app or manual variant
5. Add to homepage below hero with clear value breakdown
6. Feature in post-purchase Email 4 ("Know someone who's just starting out?")

---

## Messaging (no-ai-slop compliant)
